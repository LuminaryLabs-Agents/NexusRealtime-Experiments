...
function injectStyles(documentRef) {
  ...
  style.id = STYLE_ID;
  style.textContent = `
    :root { color-scheme:dark; --mouse-x:50%; --mouse-y:22%; --parallax-soft-x:0px; --parallax-soft-y:0px; --parallax-hot-x:0px; --parallax-hot-y:0px; --text:#fff8dc; --text-hot:#fff; --muted:#f1d9a1; --muted-2:#d1b579; --pink:#ff4fd8; --violet:#8f5cff; --cyan:#53d6ff; --green:#7cff9b; --yellow:#ffe14a; --orange:#ff8a1f; --glass-strong:rgba(13,8,26,.72); --hot-gradient:linear-gradient(90deg,#ff4fd8,#ffe14a,#7cff9b,#53d6ff,#8f5cff); --rainbow-divider:linear-gradient(90deg,transparent,#ff4fd8,#ffe14a,#7cff9b,#53d6ff,#8f5cff,transparent); --contrast-bg:#07020f; --contrast-panel:rgba(8,5,18,.84); --contrast-panel-strong:rgba(5,3,12,.92); --contrast-panel-soft:rgba(15,8,32,.76); --contrast-title:#fff; --contrast-text:#fffaf0; --contrast-muted:#ffe9b7; --contrast-dim:#dbc58d; --contrast-outline:rgba(255,255,255,.34); --contrast-outline-hot:rgba(255,225,74,.72); --contrast-shadow:0 20px 70px rgba(0,0,0,.48); --contrast-glow:0 0 32px rgba(255,225,74,.28),0 0 42px rgba(83,214,255,.18); }
    * { box-sizing:border-box; }
    ...
    .nexus-context { display:flex; align-items:center; justify-content:space-between; gap:12px; padding:12px 4px 4px; color:#ffe8b0; font-size:.82rem; font-weight:700; text-shadow:0 2px 10px rgba(0,0,0,.55); }
    ...
    .nexus-route-row { --row-x:50%; --row-y:50%; position:relative; display:grid; grid-template-columns:6px minmax(180px,1.08fr) minmax(150px,.62fr) minmax(260px,1.9fr) auto; align-items:center; gap:12px; min-height:60px; padding:0 14px 0 0; border:0; border-radius:18px; color:var(--contrast-muted); text-decoration:none; cursor:default; outline:none; overflow:visible; background:linear-gradient(90deg,rgba(255,79,216,.08),rgba(83,214,255,.06)),var(--contrast-panel); -webkit-backdrop-filter:blur(10px) saturate(1.2); backdrop-filter:blur(10px) saturate(1.2); transition:transform .18s ease,background .18s ease,box-shadow .18s ease,filter .18s ease; }
    ...
    .nexus-route-row::after { content:""; position:absolute; left:50%; bottom:-5px; width:min(70%,980px); height:3px; transform:translateX(-50%); border-radius:999px; background:var(--rainbow-divider); opacity:.56; pointer-events:none; filter:drop-shadow(0 0 8px rgba(83,214,255,.16)); transition:opacity .18s ease,height .18s ease,filter .18s ease,width .18s ease; }
    .nexus-route-row:hover { animation:happyRowBounce .34s cubic-bezier(.18,.89,.32,1.28); transform:translateX(6px) translateY(-1px) scale(1.006); background:linear-gradient(90deg,rgba(255,79,216,.16),rgba(255,225,74,.12),rgba(124,255,155,.10),rgba(83,214,255,.15)),var(--contrast-panel-strong); box-shadow:0 16px 42px rgba(0,0,0,.32),0 0 34px rgba(83,214,255,.16),0 0 28px rgba(255,79,216,.14); }
    ...
    .nexus-route-row.is-selected { background:linear-gradient(90deg,rgba(255,79,216,.22),rgba(255,225,74,.18),rgba(83,214,255,.18)),var(--contrast-panel-strong); color:var(--text-hot); box-shadow:inset 0 0 42px rgba(255,255,255,.06),0 0 38px rgba(255,225,74,.18),0 0 44px rgba(83,214,255,.16); outline:2px solid rgba(255,255,255,.26); outline-offset:0; }
    ...
    .nexus-route-accent { width:5px; height:38px; border-radius:0 999px 999px 0; background:linear-gradient(180deg,#ff4fd8,#ffe14a,#7cff9b,#53d6ff); box-shadow:0 0 16px rgba(255,225,74,.20); opacity:.82; }
    ...
    .nexus-route-title { color:var(--contrast-title); font-weight:950; letter-spacing:-.015em; overflow:hidden; text-overflow:ellipsis; white-space:nowrap; text-shadow:0 2px 12px rgba(0,0,0,.6); }
    .nexus-route-kind { color:var(--contrast-muted); font-size:.84rem; font-weight:900; overflow:hidden; text-overflow:ellipsis; white-space:nowrap; text-shadow:0 2px 10px rgba(0,0,0,.55); border-radius:999px; padding:4px 8px; background:rgba(0,0,0,.24); }
    .nexus-route-desc { color:var(--contrast-text); opacity:.94; overflow:hidden; text-overflow:ellipsis; white-space:nowrap; text-shadow:0 2px 10px rgba(0,0,0,.55); border-radius:10px; padding:4px 8px; background:rgba(0,0,0,.14); }
    .nexus-route-open { justify-self:end; color:#fff4a8; opacity:1; font-size:.75rem; font-weight:950; letter-spacing:.08em; text-transform:uppercase; text-shadow:0 0 12px rgba(0,0,0,.75),0 0 14px rgba(255,225,74,.45); border-radius:999px; padding:4px 8px; background:rgba(0,0,0,.24); }
