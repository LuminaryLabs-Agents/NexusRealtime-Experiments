export const OPEN_ABOVE_CONFIG = Object.freeze({
  ...
  physics: {
    ...
    horizontalAlignRate: 3.1,
    verticalAlignRate: 4.1,
    carveMode: "screen-focus",
    carveStrength: 0.78,
    carveResponse: 3.4,
    bankCarveScale: 1.58,
    pitchCarveScale: 1.22,
    bankTurnAuthority: 1.44,
    turnLiftLoss: 0.14,
    turnDiveAssist: 0.06,
    swoopAcceleration: 14,
    diveAcceleration: 28,
    climbAcceleration: 15,
  ...
  camera: {
    ...
    lookAhead: 25,
    smoothing: 0.14,
    lookVelocityWeight: 0.46,
    lookCarveFocusWeight: 0.34,
    followVelocityBias: 0.74,
    pitchLag: 5.5,
