...
export function createThreeRenderer({ canvas }) {
  ...
  const m = {
    ...
    aimHead: new THREE.MeshBasicMaterial({ color: 0xffffff, transparent: true, opacity: 0.96, blending: THREE.AdditiveBlending, depthWrite: false }),
    aimEnd: new THREE.MeshBasicMaterial({ color: 0x00f0ff, transparent: true, opacity: 0.88, blending: THREE.AdditiveBlending, depthWrite: false }),
    aimCore: new THREE.MeshBasicMaterial({ color: 0xffb83d, transparent: true, opacity: 0.72, blending: THREE.AdditiveBlending, depthWrite: false }),
  ...
  aimHead.frustumCulled = false;
  aimEnd.frustumCulled = false;
  aimCore.frustumCulled = false;
  aimParticles.frustumCulled = false;
